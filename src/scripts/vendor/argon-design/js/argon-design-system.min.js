  ...
  $(document).ready(function () {
    $('.dropdown-menu a.dropdown-toggle').on('click', function (e) {
      ...
      return (
        ...
        l.parent().hasClass('navbar-nav') ||
          t.next().css({ top: t[0].offsetTop, left: l.outerWidth() - 4 }),
        !1
      );
    });
    var e;
    (e = $('.form-control')).length &&
      e
    ...
    $('#choices-single-default')[0] &&
      new Choices('#choices-single-default', { search: !1 }),
      $('#choices-multiple-default')[0] &&
